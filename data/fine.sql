...
INSERT INTO `django_content_type` VALUES (1,'admin','logentry'),(3,'auth','group'),(2,'auth','permission'),(4,'auth','user'),(5,'contenttypes','contenttype'),(22,'mySql','administrador'),(19,'mySql','anuncio'),(17,'mySql','asignaciondocentecomponente'),(15,'mySql','asignaciontarea'),(18,'mySql','calificacionfinaltarea'),(9,'mySql','codigoverificacionemail'),(20,'mySql','comentarioanuncio'),(11,'mySql','componente'),(13,'mySql','datospagomatricula'),(24,'mySql','detallenotificacion'),(14,'mySql','docente'),(16,'mySql','entregatarea'),(7,'mySql','estudiante'),(21,'mySql','imagenanuncio'),(10,'mySql','matricula'),(12,'mySql','nota'),(25,'mySql','notificacion'),(23,'mySql','publicacionnotas'),(8,'mySql','representante'),(6,'sessions','session');
...
--
-- Table structure for table `mysql_administrador`
--

DROP TABLE IF EXISTS `mysql_administrador`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `mysql_administrador` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `mySql_administrador_usuario_id_8ea1f6c2_fk_auth_user_id` FOREIGN KEY (`usuario_id`) REFERENCES `auth_user` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `mysql_administrador`
--

LOCK TABLES `mysql_administrador` WRITE;
/*!40000 ALTER TABLE `mysql_administrador` DISABLE KEYS */;
INSERT INTO `mysql_administrador` VALUES (2,'Byron Valdivieso','bmvaldivieso@utpl.edu.ec','0985126545','',1);
/*!40000 ALTER TABLE `mysql_administrador` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `mysql_anuncio` VALUES (5,'Anuncio 1 - Windows 11','Windows 11 es la versión más reciente del sistema operativo Windows[5]​ desarrollado por Microsoft, además de ser el sucesor de la anterior versión del sistema operativo, Windows 10,[6]​[7]​ lanzado en 2015.[8]​ Fue lanzado oficialmente el 5 de octubre de 2021, como una actualización gratuita a través de Windows Update de Windows 10, y está disponible para aquellos equipos que cumplan con ciertas especificaciones técnicas requeridas del nuevo sistema operativo.[9]​','2025-07-20 01:31:18.338111',1,1,1);
...
--
-- Table structure for table `mysql_detallenotificacion`
--

DROP TABLE IF EXISTS `mysql_detallenotificacion`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `mysql_detallenotificacion` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `entrega_id` bigint DEFAULT NULL,
  `notificacion_id` bigint NOT NULL,
  `tarea_id` bigint DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `notificacion_id` (`notificacion_id`),
  KEY `mySql_detallenotific_entrega_id_87180b02_fk_mySql_ent` (`entrega_id`),
  KEY `mySql_detallenotific_tarea_id_f6878809_fk_mySql_asi` (`tarea_id`),
...
--
-- Dumping data for table `mysql_detallenotificacion`
--
...
INSERT INTO `mysql_docente` VALUES (1,'GORGE FERNANDO BURI ROJAS','rojas@gmail.com','0985126548',3,'docentes/perfil/perfil_47dY7mK.jpg');
...
INSERT INTO `mysql_entregatarea` VALUES (16,1,'2025-07-18 19:13:46.491303',1,9,'h',1,1),(17,2,'2025-07-18 19:15:55.674027',1,9,'Good',1,1),(19,1,'2025-07-18 20:49:57.527189',1,NULL,'',2,1);
...
INSERT INTO `mysql_imagenanuncio` VALUES (7,'anuncios/imagenes/mapa.png','',5);
...
INSERT INTO `mysql_matricula` VALUES (4,'deposito','pagina_web','2025-07-12',1,1,179.10,'confirmada',NULL,1,'1'),(6,'deposito','redes_sociales','2025-07-20',1,1,160.00,'pendiente_pago','h',2,'1');
...
INSERT INTO `mysql_nota` VALUES (3,1,2,'2025-07-13 20:18:37.291582',1,1,1,100.00,100.00,100.00,100.00),(4,1,2,'2025-07-13 20:18:58.177525',1,1,2,100.00,100.00,100.00,100.00),(5,1,1,'2025-07-20 22:22:47.282936',2,1,1,90.00,90.00,90.00,90.00),(6,1,1,'2025-07-20 22:22:47.285856',2,1,2,80.00,80.00,80.00,80.00);
/*!40000 ALTER TABLE `mysql_nota` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mysql_notificacion`
--

DROP TABLE IF EXISTS `mysql_notificacion`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `mysql_notificacion` (
  `id` bigint NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `mysql_notificacion`
--
...
--
-- Table structure for table `mysql_publicacionnotas`
--

DROP TABLE IF EXISTS `mysql_publicacionnotas`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `mysql_publicacionnotas` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  ...
  `componente_id` bigint NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `componente_id` (`componente_id`),
  CONSTRAINT `mySql_publicacionnot_componente_id_ac972951_fk_mySql_com` FOREIGN KEY (`componente_id`) REFERENCES `mysql_componente` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `mysql_publicacionnotas`
--

LOCK TABLES `mysql_publicacionnotas` WRITE;
/*!40000 ALTER TABLE `mysql_publicacionnotas` DISABLE KEYS */;
INSERT INTO `mysql_publicacionnotas` VALUES (1,1,'2025-07-20 20:02:02.000000','2025-08-02 00:00:00.000000',1),(2,1,'2025-07-20 20:32:50.000000','2025-07-30 00:00:00.000000',2);
/*!40000 ALTER TABLE `mysql_publicacionnotas` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2025-07-26 23:12:26
